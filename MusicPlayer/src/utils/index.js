...
export const isExist = (songs, track) => {
    console.log('Checking if exists:', track?.url);
...
//    - `track`: A song object to check ths is newSong(a track object) which was passed from file PlayerScreen.js to likeStore.js and finally to index.js(this file).
